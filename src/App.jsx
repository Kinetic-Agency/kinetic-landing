  ...
  return (
    <main className="min-h-screen scroll-smooth bg-black font-sans text-white selection:bg-cyan-300 selection:text-black">
      ...
      <SectionShell dark={false} className="pt-0">
        <motion.h2 variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="mx-auto max-w-4xl text-center text-4xl font-black tracking-[-0.04em] sm:text-5xl">Lo que mejoramos</motion.h2>
        <OptimizationCards />
      </SectionShell>
      <SectionShell id="proceso" className="border-y border-white/10 bg-[#050607]">
        <motion.h2 variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="mx-auto max-w-3xl text-center text-4xl font-black tracking-[-0.04em] sm:text-5xl">Un proceso claro de principio a fin.</motion.h2>
        <ProcessSteps />
      </SectionShell>
